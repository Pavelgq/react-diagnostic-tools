---
title: useMeasuredCallback
description: A drop-in useCallback that logs how long it takes every time it's called.
---

import { UseMeasuredCallbackDemo } from '@/components/demos/UseMeasuredCallbackDemo';
...
[`withExecutionTiming`](/utils/withExecutionTiming).

This measures the cost of *running* the callback, not the cost of
*creating* it - unlike [`useMemoPerformance`](/hooks/useMemoPerformance),
which analyzes a `useMemo` computation.

## Live demo

<UseMeasuredCallbackDemo />
